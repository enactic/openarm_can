...
// C++ counterpart of python/examples/test_posvel.py.
...
int main() {
    ...
    std::vector<ControlMode> control_modes = {ControlMode::POS_VEL};
    ...
    arm.get_arm().posvel_control_all({PosVelParam{0.0, 0.0}});
    arm.recv_all();
